...
Membuat folder dengan nama `lab9_php_tugas` pada directory `C:\XAMPP\htdocs` Kemudian masukkan kode pada VSCODE lalu simpan dengan nama `koneksi.php`
...
Langkah selanjutnya masukkan kode pada VSCODE lalu simpan dengan nama `header.php`
...
```<footer>
            <p>&copy; 2022, Reka Hani, 312010343, TI.20.A.2, Universitas Pelita Bangsa</p>
        </footer>
    </div>
</body>
</html>
...
Masukkan kode pada VSCODE lalu simpan dengan nama `tambah.php`
...
Masukkan kode pada VSCODE lalu simpan dengan nama `ubah.php`
...
Masukkan kode pada VSCODE lalu simpan dengan nama `hapus.php`
...
Masukkan kode pada VSCODE lalu simpan dengan nama `style.css`
...
### Berikut adalah hasil dari kode-kode yang di input pada VSCODE
